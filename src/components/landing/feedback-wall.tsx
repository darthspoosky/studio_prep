...
const FeedbackWall = () => {
  ...
  const scale = useTransform(scrollYProgress, [0.1, 0.3, 0.8, 1], [0.9, 1, 1, 0.9]);

  return (
    <section ref={targetRef} className="h-[200vh] bg-gray-50 dark:bg-gray-900/50 overflow-hidden relative">
